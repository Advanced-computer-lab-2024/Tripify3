...
import { editItineraryAttribute, createItinerary, getAllItinerariesForTourGuide, getAllItineraries, getItineraryById, updateItinerary, deleteItinerary, addActivityToItinerary , ActivateItinerary ,DeactivateItinerary} from "../controllers/itinerary/itinerary.controller.js";

const router = express.Router();

// Define routes for the itinerary
router.post("/itinerary/create", createItinerary); // Create a new itinerary
router.get("/itineraries/get/:id", getAllItinerariesForTourGuide); // Get all itineraries
