...
<FormControl fullWidth sx={{ mb: 2 }}>
        ...
        <FormGroup sx={{ mb: 2 }}>
          ...
          <Grid container spacing={1} columns={{ xs: 4, sm: 6, md: 12 }}>
            {activities.map((activity) => (
              <Grid item xs={4} sm={4} md={4} key={activity._id}> {/* 3 activity per row */}
                <Button
                  variant="contained"
        ...
        <FormGroup sx={{ mb: 2 }}>
          <Typography variant="h6" sx={{ mb: 1 }}>Places</Typography>
          <Grid container spacing={1} columns={{ xs: 4, sm: 6, md: 12 }}>
            {places.map((place) => (
              <Grid item xs={4} sm={4} md={4} key={place._id}> {/* 3 places per row */}
                <Button
                  variant="contained"
