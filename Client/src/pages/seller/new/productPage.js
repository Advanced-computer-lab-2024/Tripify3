...
export const fetchProducts = async (setProducts, setErrorMessage) => {
  const params = new URLSearchParams(window.location.search);
  const productId = "6716cb654f3ddd804aec288f";
...
function App() {
  ...
  useEffect(() => {
    fetchProducts(setProducts, setErrorMessage); // Pass state setters to fetchProducts
